...
export default function RiderNavigatorMarker({coordinate}: PProps) {
  //
  return (
    <Marker coordinate={coordinate} title="Rider Location"
      description="This is rider current location">
