...
import WithdrawalSuccessModal from "./withdraw-success";
...
const Withdraw = forwardRef<BottomSheetModal, CardProps>(
  ({ index, position, banks, amount }, ref) => {
    ...
    const onSubmit = async (data: FormData) => {
      ...
      const res = await PostRequest("/transactions/transfer", datapayload, state?.token);
      if (res?.status === 200 || res?.status === 201) {
        console.log("Transfer response", res.data.data)
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* widthrawal successful modal */}
          <WithdrawalSuccessModal amount={amount} successModal={successModal} setSuccessModal={setSuccessModal}/>
        </BottomSheetScrollView>
