...
const Selfie = () => {
   ...
   const {selfieUploadedFile: uploadedFile} = state
   
       const handleImageUpload = (file: UploadedFile) => {
           dispatch({type: ACTIONS.SELFIE_UPLOADED_FILE, payload: file})
       };
   
       const removeImage = () => {
           dispatch({ type: ACTIONS.SELFIE_UPLOADED_FILE, payload: null })
       };
