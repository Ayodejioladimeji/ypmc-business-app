...
import { KycDocument } from "@/components/rider-components/kyc-document";
import { KycContact } from "@/components/rider-components/kyc-contact";
  ...
  const formSections = [
    {
      ...
      render: () => (
        <View style={{ paddingHorizontal: 10, gap: 10 }}>
          <Text style={{ fontFamily:"interSemiBold", fontSize: s(22) }}>
