...
import RiderRowSection from "@/components/org-components/rider-row";
...
const ShipmentDetails = () => {
  ...
  const getTransactions = async () => {
    const res = await GetRequest(`/transactions/partner/${id}`, token)
        ...
        {/* {!transaction?.shipping &&
         <>
          ...
          <>
            ...
            <RiderRowSection order={transaction} />
...
const styles = StyleSheet.create({
  ...
  category: { fontSize: s(14), fontWeight: 500 },
  status: {
